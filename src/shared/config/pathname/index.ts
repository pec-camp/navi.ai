...
export const TOOLS_SLUG_REVIEWS_REVIEW_FORM_PATHNAME = (slug: string) => `/tools/${slug}/reviews/review-form`;
...
export const ROUTES = {
  ...
  TOOLS_SLUG_REVIEWS_REVIEW_FORM_PATHNAME
} as const;

// Type for all static routes
export type StaticRoute = "/" | "/account" | "/compare-result" | "/contact" | "/help" | "/login" | "/onboarding" | "/privacy" | "/profile" | "/reset-password" | "/sign-up" | "/subscriptions" | "/subscriptions/subscribe" | "/terms" | "/tools";

// Type for dynamic route functions
export type DynamicRoute = typeof TOOLS_SLUG_PATHNAME | typeof TOOLS_SLUG_FAQ_PATHNAME | typeof TOOLS_SLUG_PRICING_PATHNAME | typeof TOOLS_SLUG_REVIEWS_PATHNAME | typeof TOOLS_SLUG_REVIEWS_REVIEW_FORM_PATHNAME;
